...
./blender-4.5.3-linux-x64/blender -b v1.blend --quiet --python gen.py -- --gpu 0 --n_capture 5 --n_scene 5 --cycles-device OPTIX
```
...
By default resolution is set to 1920x1200.
